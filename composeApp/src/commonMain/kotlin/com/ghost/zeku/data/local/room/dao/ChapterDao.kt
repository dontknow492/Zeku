...
interface ChapterDao {
    ...
    @Query("SELECT * FROM chapters WHERE mediaId = :mediaId AND source = :source ORDER BY number DESC")
    ...
    @Query("SELECT * FROM chapters WHERE mediaId = :mediaId AND source = :source")
