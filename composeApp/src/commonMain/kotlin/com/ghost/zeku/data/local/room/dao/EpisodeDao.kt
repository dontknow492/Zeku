...
interface EpisodeDao {
    ...
    @Query("SELECT * FROM episodes WHERE mediaId = :mediaId AND source = :source ORDER BY number ASC")
    ...
    @Query("DELETE FROM episodes WHERE mediaId = :mediaId AND source = :source")
    ...
    @Query("SELECT * FROM episodes WHERE mediaId = :mediaId AND source = :source")
