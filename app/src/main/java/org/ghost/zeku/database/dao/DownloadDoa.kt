...
interface DownloadDao {
    ...
    fun getQueuedScheduledDownloadsUntilWithPriority(
        currentTime: Long,
        priorityItems: List<Long>
    ...
    fun checkStatus(id: Long): Status?
    ...
    @Query(
        "SELECT COUNT(downloadStartTime) = 0 from downloads WHERE id in (:items) AND " +
                "CASE :inverted " +
    ...
    fun checkAllQueuedItemsAreScheduledAfterNow(
        items: List<Long>,
        inverted: String,
