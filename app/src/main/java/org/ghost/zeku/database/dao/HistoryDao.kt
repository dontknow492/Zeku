package org.ghost.zeku.database.dao
...
interface HistoryDao {
    ...
    @Query(
        "SELECT * FROM history WHERE (title LIKE '%'||:query||'%' OR author LIKE '%'||:query||'%') AND type LIKE '%'||:type||'%' AND website LIKE '%'||:site||'%' ORDER BY " +
                "CASE WHEN :sort = 'ASC' THEN id END ASC," +
                "CASE WHEN :sort = 'DESC' THEN id END DESC," +
                "CASE WHEN :sort = '' THEN id END DESC "
    )
    fun getHistorySortedByIDPaginated(
        query: String,
        type: String,
        site: String,
        sort: String
    ...
    fun getHistorySortedByTitlePaginated(
        query: String,
        type: String,
        site: String,
        sort: String
    ...
    fun getHistorySortedByAuthorPaginated(
        query: String,
        type: String,
        site: String,
        sort: String
    ...
    fun getHistorySortedByFilesizePaginated(
        query: String,
        type: String,
        site: String,
        sort: String
    ...
    @Query(
        "SELECT id, downloadPath FROM history WHERE (title LIKE '%'||:query||'%' OR author LIKE '%'||:query||'%') AND type LIKE '%'||:type||'%' AND website LIKE '%'||:site||'%' ORDER BY " +
                "CASE WHEN :sort = 'ASC' THEN id END ASC," +
                "CASE WHEN :sort = 'DESC' THEN id END DESC," +
                "CASE WHEN :sort = '' THEN id END DESC "
    )
    fun getHistoryIDsSortedByID(
        query: String,
        type: String,
        site: String,
        sort: String
    ): List<HistoryIDsAndPaths>
    ...
    fun getHistoryIDsSortedByTitle(
        query: String,
        type: String,
        site: String,
        sort: String
    ...
    fun getHistoryIDsSortedByAuthor(
        query: String,
        type: String,
        site: String,
        sort: String
    ...
    fun getHistoryIDsSortedByFilesize(
        query: String,
        type: String,
        site: String,
        sort: String
    ...
    fun getAllHistoryByURLAndType(url: String, type: MediaType): List<HistoryItem>
    ...
    fun getDownloadPathsFromIDs(ids: List<Long>): List<HistoryItemDownloadPaths>
